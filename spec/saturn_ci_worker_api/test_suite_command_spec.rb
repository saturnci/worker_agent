  ...
  describe 'test_filenames_string' do
    context 'concurrency 2, order index 1' do
      ...
      it 'includes the first two test files' do
        test_filenames = ['spec/models/github_token_spec.rb', 'spec/rebuilds_spec.rb', 'spec/sign_up_spec.rb',
                          'spec/test_spec.rb']
    ...
    describe 'chunking' do
      ...
      it 'distributes all 77 files across 4 runners without losing any' do
        ...
        command1 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, run_order_index: '1')
        command2 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, run_order_index: '2')
        command3 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, run_order_index: '3')
        command4 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, run_order_index: '4')
      ...
      it 'distributes all 20 files across 2 runners without losing any' do
        ...
        command1 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, number_of_concurrent_runs: '2',
                                                                             run_order_index: '1')
        command2 = SaturnCIWorkerAPI::TestSuiteCommand.new(**default_params, number_of_concurrent_runs: '2',
                                                                             run_order_index: '2')
